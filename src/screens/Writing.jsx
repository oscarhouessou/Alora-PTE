...
import { ArrowLeft, Pencil, ChevronRight, FileText, PenTool, Type, FileEdit } from 'lucide-react'
import BottomNav from '../components/common/BottomNav'

const exercises = [
    { id: 'summarize-written-text', title: 'Summarize Written Text', questions: 120, icon: <FileText size={24} />, color: 'text-emerald-600', bg: 'bg-emerald-50' },
    { id: 'write-essay', title: 'Write Essay', questions: 437, icon: <PenTool size={24} />, color: 'text-orange-600', bg: 'bg-orange-50' },
]
        ...
        <div className="min-h-screen bg-bg-light pb-32 bg-mesh-primary">
            <header className="px-6 pt-12 pb-6">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">Writing</h1>
                        <p className="text-sm text-slate-500 font-medium">Master academic writing skills</p>
                    </div>
                </div>

                <div className="glass-card p-6 border-none flex items-center gap-4 bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-xl shadow-emerald-100">
                    <div className="w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center">
                        <Pencil size={24} />
                    </div>
                    <div>
                        <p className="text-[10px] font-bold uppercase tracking-widest opacity-80">Total Content</p>
                        <p className="text-xl font-bold">557 Questions</p>
                    </div>
                </div>
            </header>
